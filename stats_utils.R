#--------------------------------------------------------------------------------------
#
# stats_utils.R utilities for peforming some common statistical functions
#
# August 2017
# Richard Judson
#
...
#
# Args:
#   x: number of true positives
#   Class: number of false positives
#
# Returns:
#   txt: the result of teh function TxT
