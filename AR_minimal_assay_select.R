...
prep.data <- function() {
  ...
  assay.list <- c("NVS_NR_hAR","NVS_NR_cAR","NVS_NR_rAR","OT_AR_ARSRC1_0480","OT_AR_ARSRC1_0960","OT_AR_ARELUC_AG_1440","ATG_AR_TRANS_up","TOX21_AR_BLA_Agonist_ratio","TOX21_AR_LUC_MDAKB2_Agonist","TOX21_AR_BLA_Antagonist_ratio","TOX21_AR_LUC_MDAKB2_Antagonist2","ACEA_AR_agonist_80hr","ACEA_AR_antagonist_80hr")
  assay.class <- c("R3",       "R3",        "R3",        "R4",               "R4",               "R6",                  "R5",             "R6",                        "R6",                         "R7",                           "R7",                             "R18",                 "R19")
  
  file <- "../output/superMatrix_3 2018-08-21.xlsx"
  full.model <- read.xlsx(file)
